...
//   const newBadge = isRecent ? `<a href="${link}" target="_blank"><span class="new-badge"><img src="star-new.png" alt="New"></span></a>` : '';
...
newsItems.forEach(({ element, date }) => {
  ...
  if (isRecent) {
    // Recent → show star image clickable
    newsHTML = `
      <div class="news-text">
        ${text} 
    ...
    // Older → make entire text clickable
    newsHTML = `
      <div class="news-text">
